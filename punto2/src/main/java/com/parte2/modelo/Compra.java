...
public class Compra {
    ...
    /**
     * Metodo para que el cliente pueda crear un objeto de estrategia específica y asignarlo a la compra
     ...
     * y muestra el tiempo estimado de entrega utilizando la estrategia de envío seleccionada.
     */
    public void procesarCompra() {
        if (metodoEnvio == null) {
            System.out.println("Por favor, selecciona un método de envío.");
            return;
        }
